...
|3 | **[Testing Big and Small – Part 2](slides/3-unit-testing.pdf)**<ul><li>Unit Testing<ul><li>Avoiding Brittle Tests</li><li>Writing Clear Unit Tests</li></ul><li>Test Doubles</li></ul> | [Better Unit Testing](practicals/) ([Solutions](practicals/)) |
